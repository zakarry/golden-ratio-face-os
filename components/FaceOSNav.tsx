...
// Mobile bottom bar: show 4 primary + "もっと" for the rest
const MOBILE_PRIMARY: NavId[] = ['home', 'identity', 'condition', 'design'];
const MOBILE_MORE: NavId[] = ['karte', 'insight'];

export default function FaceOSNav({ active, onNavigate, gender, onGenderChange }: FaceOSNavProps) {
